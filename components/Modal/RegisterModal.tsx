...
const RegisterModal: React.FC<RegisterModalProps> = ({
  ...
  return (
    <>
      {!showOtpModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/70 dark:bg-transparent bg-opacity-50 z-50 px-4">
      ...
      {showOtpModal && (
        <VerifyOtpModal
          ...
          onSuccess={() => {
            ...
            handleModalclose(); // close the register modal too
            openLogin();
          }}
        />
      )}
